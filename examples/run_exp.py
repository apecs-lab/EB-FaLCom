...
#     "--server_config", type=str, default="./resources/configs/cifar10/server_fedavg.yaml"
# )
argparser.add_argument(
    "--server_config", type=str, default="./resources/configs/cifar10/server_FaLCom.yaml"
)
argparser.add_argument(
